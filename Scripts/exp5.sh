...
python3 trainer.py --exp_name 56cifar --dataset cifar10 --config hyperparameters/cifar10/56cifar10.yaml --device cuda:2
python3 trainer.py --exp_name 57cifar --dataset cifar10 --config hyperparameters/cifar10/57cifar10.yaml --device cuda:2

python3 trainer.py --exp_name 58cifar --dataset cifar10 --config hyperparameters/cifar10/58cifar10.yaml --device cuda:2
python3 trainer.py --exp_name 59cifar --dataset cifar10 --config hyperparameters/cifar10/59cifar10.yaml --device cuda:2
